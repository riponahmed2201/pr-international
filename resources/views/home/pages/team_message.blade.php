                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="about-content">
                        <div class="row">
                            <div class="col-md-4">
                                <figure>
                                    <img class="frame img__frame" style="width: 350px; height:350px" src="{{ asset('assets/frontend/images/proprietor.JPG')}}" alt="">
                                </figure>
                            ...
                            <div class="col-md-8">
                                <p class="wow all__font__change text-justify fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                    ...
                                    produce success to get more projects.
                                </p>
                            </div>
                        </div>
<br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <p class="wow all__font__change text-justify fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                    ...
                                    I give thanks to our principals and clients for their continued support.
                                </p>
                            </div>
                        </div>
